...
const testimonials = [
  {
    ...
    logo: 'https://sitacorp.com/img/logo-iie.png',
    quote:
  ...
  },
  {
    ...
    logo: 'https://sitacorp.com/img/shrd-it.png',
    quote:
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <h2 className="text-3xl font-bold mb-10" data-aos="fade-up">Customer Testimonials</h2>
